    ...
    <div class="register">
      ...
      <form action="${pageContext.request.contextPath}/reset" method="post">
        <div class="register-top-grid">
          <h3>Reset</h3>
          <div class="input">
            <input type="hidden" name="userId" readonly required hidden="hidden" value="${user.id}">
          </div>
          <div class="input">
            <span>username</span>
            <input type="text" name="username" required readonly value="${user.username}">
          </div>
          <div class="input">
            <span>password <label style="color: red">*</label> </span>
            <input type="password" name="password" id="password" oninput="checkPasswordStrength(this.value)" placeholder="input the new password" required="required">
          ...
          <div class="input">
            ...
            <input type="text" name="email" placeholder="input your email address" required="required" value="${user.email}" oninput="validateEmail(this.value)">
            <p id="emailMessage" style="font-size: 14px;"></p>
          </div>
        </div>
        <div class="register-but text-center">
          <input name="register" type="submit" value="reset">
        </div>
